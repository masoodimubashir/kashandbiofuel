(function ($) {
  ...
  grid: {
    ...
    markers: {
        discrete: [{
            seriesIndex: 0,
            dataPointIndex: 3,
            fillColor: KabulAdminConfig.secondary,
            strokeColor: "#fff",
            size: 6,
            shape: "circle"
        },
  ...
  var optionscolumnchart = {
    ...
    colors: [KabulAdminConfig.secondary, "#479447", KabulAdminConfig.primary],
    fill: {
      type: "gradient",
      gradient: {
        shade: "light",
      ...
      xaxis: [
        {
          ...
          strokeDashArray: 0,
          borderColor: KabulAdminConfig.primary,
          label: {
            borderColor: KabulAdminConfig.primary,
            offsetY: 20,
            style: {
              color: "#fff",
              background: KabulAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var optionscandlestickchart = {
    ...
    plotOptions: {
      candlestick: {
        colors: {
          upward: KabulAdminConfig.primary,
          downward: KabulAdminConfig.secondary,
        },
      },
    },
    legend: {
  ...
  colors: [ '#bebebe' , KabulAdminConfig.primary],
  dropShadow: {
    enabled: true,
    top: 5,
    left: 6,
  ...
  var options = {
    ...
    legend: {
      ...
      colors: [KabulAdminConfig.primary, '#EAEAEA'],
    fill: {
      ...
      gradient: {
        ...
        type: "vertical",
        shadeIntensity: 1,
        gradientToColors: [ KabulAdminConfig.primary, '#fff5f7', KabulAdminConfig.primary ],
        inverseColors: true,
        opacityFrom: 0.4,
        opacityTo: 0,
        stops: [0, 100, 100, 100],
