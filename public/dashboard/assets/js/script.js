/*! -----------------------------------------------------------------------------------
    Template Name: Kabul Admin
    Template URI: https://admin.pixelstrap.net/Kabul/template/
...
(function ($) {
  ...
  $(".mode").on("click", function () {
    ...
    if (!bodyModeDark) {
      ...
      localStorage.setItem("mode-Kabul", "dark-only");
      $("body").addClass("dark-only");
      $("body").removeClass("light");
    }
    if (bodyModeDark) {
      $(".mode").removeClass("active");
      localStorage.setItem("mode-Kabul", "light");
      $("body").removeClass("dark-only");
      $("body").addClass("light");
    }
  });
  $("body").addClass(
    localStorage.getItem("mode-Kabul")
      ? localStorage.getItem("mode-Kabul")
      : "light"
  );
  $(".mode").addClass(
    localStorage.getItem("mode-Kabul") === "dark-only" ? "active" : " "
  );
  // sidebar filter
...
// end loader
  ...
  $(document).ready(function () {
    $('.blog-like').click(function () {
      $(this).toggleClass('clicked-color');
    });
  });
})(jQuery);
