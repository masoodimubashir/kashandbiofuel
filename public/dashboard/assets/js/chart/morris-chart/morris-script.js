  ...
  var morris_chart = {
    init: function () {
      Morris.Area({
        ...
        ykeys: ["y", "z"],
        labels: ["Y", "Z"],
        lineColors: [KabulAdminConfig.secondary, KabulAdminConfig.primary],
      }),
        Morris.Line({
          ...
          xkey: "y",
          ykeys: ["a", "b"],
          lineColors: [KabulAdminConfig.primary, KabulAdminConfig.secondary],
        ...
        Morris.Bar({
          ...
          ykeys: ["y"],
          labels: ["Y"],
          barColors: [KabulAdminConfig.primary],
        }),
        $(function () {
          var b = [
            {
          ...
          Morris.Bar({
            ...
            data: b,
            barColors: [KabulAdminConfig.primary, KabulAdminConfig.secondary],
            xkey: "period",
        ...
        $(function () {
          ...
          window.m = Morris.Line({
            ...
            labels: ["sin(x)"],
            parseTime: !1,
            lineColors: [KabulAdminConfig.primary],
