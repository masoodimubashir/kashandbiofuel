(function ($) {
  ...
  setTimeout(function () {
    $("#line-chart-sparkline").sparkline(
      [5, 10, 20, 14, 17, 21, 20, 10, 4, 13, 0, 10, 30, 40, 10, 15, 20],
      {
        ...
        lineColor: KabulAdminConfig.primary,
        fillColor: "rgba(103, 143, 68, 0.40)",
        highlightLineColor: KabulAdminConfig.primary,
        highlightSpotColor: KabulAdminConfig.primary,
        targetColor: KabulAdminConfig.primary,
        performanceColor: KabulAdminConfig.primary,
        boxFillColor: KabulAdminConfig.primary,
        medianColor: KabulAdminConfig.primary,
        minSpotColor: KabulAdminConfig.primary,
      }
    );
  });
  ...
  $("#custom-line-chart").sparkline([5, 30, 27, 35, 30, 50, 70], {
    ...
    tooltipClassname: "chart-sparkline",
    chartRangeMax: "50",
    lineColor: KabulAdminConfig.secondary,
    fillColor: "rgba(209, 130, 63, 0.30)",
  ...
  $("#custom-line-chart").sparkline([0, 5, 10, 7, 25, 20, 30], {
    ...
    lineColor: KabulAdminConfig.primary,
    fillColor: "rgba(103, 143, 68, 0.40)",
    highlightLineColor: "rgba(103, 143, 68, 0.40)",
    ...
    init: function () {
      setTimeout(function () {
        ...
        $("#bar-chart-sparkline").sparkline([5, 2, 2, 4, 9, 5, 7, 5, 2, 2, 6], {
          ...
          height: "100%",
          tooltipClassname: "chart-sparkline",
          barColor: KabulAdminConfig.primary,
        }),
        $("#pie-sparkline-chart").sparkline([1.5, 1, 1, 0.5], {
          ...
          sliceColors: [
            "#479447",
            "#e69800",
            KabulAdminConfig.secondary,
            KabulAdminConfig.primary,
          ],
          tooltipClassname: "chart-sparkline",
        });
    },
