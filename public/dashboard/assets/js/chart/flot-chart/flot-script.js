(function ($) {
  ...
  if ($("#flot-basic-chart").length > 0) {
    ...
    $.plot("#flot-basic-chart", [a, c, d], {
      ...
      colors: ["#479447", "#479447", "#479447", "#479447"],
    });
  }
...
$(function () {
  ...
  var data = [
    { color: "#e87f24", points: data1_points, data: data1, label: "data1" },
    { color: "#4FA7F4", points: data2_points, data: data2, label: "data2" },
    {
      color: "#e69800",
      lines: { show: true },
      points: data3_points,
    ...
    { color: "#479447", points: data3_points, data: data4_errors },
  ];
