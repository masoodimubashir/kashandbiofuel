var kanban1 = new jKanban({
  ...
  boards: [{
      ...
      'item': [{
          'title': `
                               <a class="kanban-box" href="#"><span class="date">23/7/20</span><span class="ribbon ribbon-primary ribbon-bookmark ribbon-right">medium</span>
        ...
        {
          'title': `
                               <a class="kanban-box" href="#"><span class="date">24/7/20</span><span class="ribbon ribbon-danger ribbon-bookmark ribbon-right">Argent</span>
                                <h6>Test Sidebar</h6>
                                <div class="d-flex"><img class="img-20 me-1 rounded-circle" src="../assets/images/user/3.jpg" alt="" data-original-title="" title="">
                                  <div class="flex-grow-1">
                                    <p>Themeforest, australia</p>
    ...
    },
    {
      ...
      'item': [{
        ...
        {
          'title': `
                               <a class="kanban-box" href="#"><span class="date">24/7/20</span><span class="ribbon ribbon-success ribbon-bookmark ribbon-right">Low</span>
...
var kanban2 = new jKanban({
  ...
  boards: [{
      ...
      'item': [{
          'title': `
                               <a class="kanban-box" href="#"><span class="date">24/7/20</span><span class="ribbon ribbon-info ribbon-bookmark ribbon-right">medium</span>
                                <h6>Test Sidebar</h6>
                                <div class="d-flex"><img class="img-20 me-1 rounded-circle" src="../assets/images/user/3.jpg" alt="" data-original-title="" title="">
                                  <div class="flex-grow-1">
                                    <p>Themeforest, australia</p>
