                    ...
                    <div class="order-box">
                        ...
                        <div class="order-contain">
                            ...
                            <h5 class="text-content">
                                <b>
                                    Your Order Is Confirmed You Will Get Notified Via Mail Once Your Order Is Shipped.
                                    <br>
                                    Sit back And Relax
                                </b>
                            </h5>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="product-detail">
                                        <div class="product border-0">
                                            <div class="product-detail">
                                                <ul>
                                                    <li class="name">{{ $item->product->name ?? '' }}</li>
                                    ...
                                    <td class="price">
                                        ...
                                        <h6 class="theme-color">₹{{ number_format($item->price, 2) }}</h6>
                                    </td>
                                    <td class="subtotal">
                    ...
                    <div class="col-lg-12 col-sm-6">
                        <div class="summery-box">
                            ...
                            <ul class="summery-total">
                                <li class="list-total">
                                    <h4>Total (INR)</h4>
                                    <h4 class="price">₹{{ number_format($order->total_amount, 2) }}</h4>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="summery-box pb-4">
                            ...
                            <ul class="summery-contain pb-0 border-bottom-0">
                                <li class="d-block">
                                    ...
                                    <h4>PIN: {{ $order->address->pin_code }}</h4>
                                    <h4>Phone: {{ $order->address->phone }}</h4>
                                </li>
                                <li class="pb-0">
                                    <h4 class="price theme-color">
                                        <a href="{{ route('track-order', $order->id) }}" class="text-danger">Track Order</a>
                                    </h4>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="summery-box">
                            ...
                            <ul class="summery-contain pb-0 border-bottom-0">
                                <li class="d-block pt-0">
                                    ...
                                    <p>Transaction ID: {{ $order->custom_order_id }}</p>
                                    <p>Amount: ₹{{ number_format($transaction->amount, 2) }}</p>
                                    <p>Status: {{ $transaction->status ? 'Success' : 'Pending' }}</p>
                                </li>
                            </ul>
                        </div>
                    </div>
