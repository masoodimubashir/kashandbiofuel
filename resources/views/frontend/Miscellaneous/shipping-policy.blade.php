...
@section('main')
    <div class="container border shadow border-rounded mt-5 mb-5 p-5">
        ...
        <div class="mt-4">
            ...
            <br>
            <p class="ps-4">Standard delivery within India: 5-7 business days. Express delivery within India: 2-4
                business
                days.</p>
            <p class="ps-4">International delivery: 7-15 business days, depending on the destination.</p>
        </div>
        ...
        <footer class="text-center mt-5">
            <p class="p-4">Thank you for shopping with Kassh & Biofuel.</p>
        </footer>
    </div>
@endsection
