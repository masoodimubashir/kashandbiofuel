                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="../assets/images/fashion/product/23.jpg" id="img-1"
                                                         data-zoom-image="../assets/images/fashion/product/23.jpg"
                                                         class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="../assets/images/fashion/product/24.jpg"
                                                         data-zoom-image="../assets/images/fashion/product/24.jpg"
                                                         class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="../assets/images/fashion/product/25.jpg"
                                                         data-zoom-image="../assets/images/fashion/product/25.jpg"
                                                         class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="../assets/images/fashion/product/26.jpg"
                                                         data-zoom-image="../assets/images/fashion/product/26.jpg"
                                                         class="
                            ...
                            <div class="bundle-list">
                                <ul>
                                    ...
                                    <li class="content">
                                        ...
                                        <h4 class="theme-color">$210.69
                                            <del class="text-content">212.36</del>
                                        </h4>
                                        <button class="btn text-white theme-bg-color btn-md mt-sm-4 mt-3 fw-bold"><i
                                                class="fa-solid fa-cart-shopping me-2"></i> Add All To Cart
                                        </button>
                                    </li>
                                </ul>
                            </div>
