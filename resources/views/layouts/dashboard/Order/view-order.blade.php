<x-app-layout>
    ...
    <div class="container-fluid py-4">
        <!-- Action Bar -->
        <div class="card mb-4">
            <div class="card-body d-flex gap-3 jus">
                ...
                <span class="badge bg-warning px-3 py-2 d-flex align-items-center">
                    {{ $order['status'] }} - {{ $order['order_message'] }}
                </span>
            </div>
        </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ $item['image'] ?? asset('default_images/product_image.png') }}"
                                                        class="rounded me-3" style="width: 48px" alt="">
